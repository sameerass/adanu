          ...
          <Carousel/>
            <div className='row blue'>
              <section className='leaderboard'>
                  <h2>
                    Adanu ignites the passion of Ghanaian communities to bring about
                ...
                <section className='responsive_wrap_fullwidth'>
                  <article className='thirtythree'>
                    ...
                    <p>
                      ...
                      development projects that benefit people young and old across Ghanaian villages.
                      <br />
                      <br />
                  ...
                  <article className='thirtythree'>
                    ...
                    <p>
                      Adanu partners with communities to foster a spirit of collaboration and ownership.
                      This creates authentic community development and true sustainability.
                      <br />
                      <br />
                      Every Adanu project is run jointly with local community leaders.
                      This creates ownership, authentic community development and true sustainability.
                    </p>
                  </article>
                  <article className='thirtythree'>
                    ...
                    <p>
                      Providing children with an education empowers them to improve their
                      lives and the lives of their families.
                      <br />
                      <br />
                      Adanu ignites possibilities. Education brings knowledge; knowledge opens doors;
                      doors wide open create a legacy of hope.
                    </p>
                  </article>
                </section>
            </div>
